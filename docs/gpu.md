...
> **_NOTE:_**  The wheel file is only compatible with x86_64 linux based architecture. You can check the architecutere of your linux system through the following command:
```
uname -a
```
```
